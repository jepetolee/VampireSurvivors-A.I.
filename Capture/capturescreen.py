...
def finding_boss_entities(src, value):
    ...
    h1, w1 = temp1.shape
    temp1 = (temp1, h1, w1)
    temp2 = cv.imread("./data/boss_entity/boss_bat_r.png")
    temp2 = cv.cvtColor(temp2, cv.COLOR_RGB2GRAY)
    h2, w2 = temp2.shape
    temp2 = (temp2, h2, w2)
    temp3 = cv.imread("./data/boss_entity/boss_bat2_r.png")
    temp3 = cv.cvtColor(temp3, cv.COLOR_RGB2GRAY)
    h3, w3 = temp3.shape
    temp3 = (temp3, h3, w3)
    temp4 = cv.imread("./data/boss_entity/boss_bat2_l.png")
    temp4 = cv.cvtColor(temp4, cv.COLOR_RGB2GRAY)
    h4, w4 = temp4.shape
    temp4 = (temp4, h4, w4)
    temp5 = cv.imread("./data/boss_entity/mantis_s_l.png")
    temp5 = cv.cvtColor(temp5, cv.COLOR_RGB2GRAY)
    h5, w5 = temp5.shape
    temp5 = (temp5, h5, w5)
    temp6 = cv.imread("./data/boss_entity/mantis_s_r.png")
    temp6 = cv.cvtColor(temp6, cv.COLOR_RGB2GRAY)
    h6, w6 = temp6.shape
    temp6 = (temp6, h6, w6)
    temp7 = cv.imread("./data/boss_entity/mantis_b_l.png")
    temp7 = cv.cvtColor(temp7, cv.COLOR_RGB2GRAY)
    h7, w7 = temp7.shape
    temp7 = (temp7, h7, w7)
    temp8 = cv.imread("./data/boss_entity/mantis_b_r.png")
    temp8 = cv.cvtColor(temp8, cv.COLOR_RGB2GRAY)
    h8, w8 = temp8.shape
    temp8 = (temp8, h8, w8)
...
def main():
    ...
    '''for result in results:
        for (x, y, h, w) in result:
            cv.rectangle(img_frame, (x, y), (x + w, y + h), (blue, green, rand), 3)
        if i % 3 == 0:
            rand = rand + 15
        elif i % 3 == 1:
            green = green + 25
    ...
    cv.imwrite("output.png", img_frame)
