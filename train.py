...
def run():
    ...
    while count > 0:
        ...
        for t in range(num):
            if s_len > 30:
                s_list1 = s_list[s_len - 31-t*30:-2-t*30]
                s_prime_list = s_list[s_len - (t+1)*30:-1-t*30]
                r_list1 = r_list[s_len - 31-t*30:-2-t*30]
                a_list1 = a_list[s_len - 31-t*30:-2-t*30]
                policy_list1 = policy_list[s_len - (t+1)*30:-1-t*30]

            else:
                s_list1 = s_list[:left-2]
                s_prime_list = s_list[1:left-1]
                r_list1 = r_list[:left-2]
                a_list1 = a_list[:left-2]
                policy_list1 = policy_list[1:left-1]
